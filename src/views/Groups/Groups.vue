<template>
  <Layout>
    <div class="border-b border-gray-200 mb-10 relative">
          <h1 class="py-5 transition text-xl font-bold"><i class="uil uil-user-circle text-xl"></i>  Consensus Group</h1>
       </div>
        ...
        <table class="table-auto">
          <thead>
            <tr>
              ...
              <th class="w-1/2 px-6 py-4 text-emerald-600">Public Key</th>
          ...
          <tbody>
            <tr v-for="group , i in groups" :key="group.id">
              ...
              <td class="border border-emerald-500 px-6 py-4 text-emerald-600 font-medium">{{group.name}}</td>
              <td class="border border-emerald-500 px-6 py-4 text-emerald-600 font-medium break-all">{{group.public_key}}</td>
              <td class="cursor-pointer hover:bg-gray-100 transition flex border border-emerald-500 px-4 py-8 text-emerald-600 font-medium">
