  ...
  <Layout title="Dashboard">
    <div class="border-b border-gray-200 mb-10 relative">
      <h1 class="py-5 transition text-xl font-bold">
        <i class="uil uil-create-dashboard text-xl"></i> Dashboard
      </h1>
    </div>
    <div class="flex flex-wrap">
      <div class="w-1/2">
        <div class="m-3">
          <a
            ...
            "
          >
            <div class="mb-2 p-4 pb-10">
              <p class="text-sm text-white-600 flex items-center">
                <svg
                  class="fill-current text-white-100 w-3 h-3 mr-2"
              ...
              <div class="text-white-900 font-medium py-2 mb-2">
                Visit your government issued digital identity
              </div>
            </div>
          </a>
        </div>
      ...
      <div
        class="w-full md:w-1/2 lg:w-1/2 xl:w-1/2"
        v-for="election in elections"
        :key="election.id"
      >
        <div class="m-3">
          <router-link
            :to="`/elections/${election.id}/cast-vote`"
            class="
              block
              pb-5
              hover:bg-green-500
            ...
            "
          >
            <div class="break-word word-wrap mb-2 p-3">
              <div class="text-sm rounded-md flex">
